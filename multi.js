      ...
      for(const p of arr){
        ...
        if(!pl){
          pl={ id:p.id, name:p.name||'Angler', color:p.color||colorOf(p.id), lvl:p.lvl||1, boat:p.boat||'surf',
            title:p.title||'', badges:p.badges||{betaTester:!!p.beta,daveTest:false,creator:false,booty:false,pinkfong:false,witchy:false}, x:+(p.x||0), y:+(p.y||0), head:+(p.head||0),
        ...
        pl.title=p.title||pl.title; pl.badges=p.badges||{betaTester:!!p.beta,daveTest:false,creator:false,booty:false,pinkfong:false,witchy:false}; pl.color=p.color||pl.color; pl.at=now;
      }
